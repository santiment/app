...
export const APP_UPDATE_INSIGHT_DRAFT = '[app] UPDATE_INSIGHT_DRAFT'
export const APP_DELETE_INSIGHT_DRAFT = '[app] DELETE_INSIGHT_DRAFT'
...
export const USER_REMOVED_ASSET_FROM_LIST_FAILED =
  '[user] REMOVED_ASSET_FROM_LIST'
export const USER_CHOOSE_ASSET_LIST = '[user] USER_CHOOSE_ASSET_LIST'
