...
const Search = ({
  ...
  return (
      ...
      valueContent={(text) => {
        ...
        return detectedAsset ? (
          <div className={styles.content}>
            <DarkTooltip
              ...
              trigger={
                ...
                >
                  <Toggle
                    IconActive={(props) => (
                      <svg xmlns='http://www.w3.org/2000/svg' width='7' height='10' {...props}>
                        <path
                          fill='#fff'
            ...
            <Link className={styles.link} to={`/projects/${detectedAsset.slug}`}>
              <DarkTooltip
                position='top'
                align='start'
                on='hover'
    ...
    >
      ...
      {isMaxValuesReached && (
        <span className={styles.limit}>To add a new word, please delete one</span>
      )}
    </MultiInput>
  )
}
