...
const HelpPopupTrends = ({ className, triggerClassName }) => (
  <HelpPopup className={className} triggerClassName={triggerClassName}>
    ...
    <ul className={styles.list}>
      ...
      <li className={styles.item}>
        <code>btc AND moon</code> will search for comments including both <code>btc</code> and{' '}
        <code>moon</code>
      </li>
      <li className={styles.item}>
        <code>btc OR moon</code> will search for comments including either <code>btc</code> or{' '}
        <code>moon</code>
      </li>
      <li className={styles.item}>
