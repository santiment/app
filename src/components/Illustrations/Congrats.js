...
const Congrats = ({ className }) => (
  <svg width='115' height='93' fill='none' className={className}>
    <g fill='var(--porcelain)'>
      <path d='M85.7 37c-6.3-2.6-2.6 7.6 0 13 .6 1.4 2.3 8.3 0 15.4-2.3 7-8.1 5.7-14.3 10.8-6.2 5.2-10.7-1.9-18.9 3.2-8.5 5.4-10.7 3.9-18.5 3.9-7.8 0-17.5-.7-21.1 3.2C9.3 90.3 1.5 85.2.2 89-1.1 93 4.1 94.1 10.9 92c6.9-2.2 11.7-.3 23.1-2.9 11.4-2.5 10.7 1 24.7-2.5 14-3.6 20.2-5.1 27-10.3 6.8-5 7.5-14.3 8.8-18.5 1.3-4.2-1-17.6-8.8-20.8z' />
