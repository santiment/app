...
const SOCIAL_MEDIAS = [
  {
    ...
    item: (
      <svg className={styles.discord} width='20' height='15' xmlns='http://www.w3.org/2000/svg'>
        <path
          fillRule='evenodd'
          clipRule='evenodd'
  ...
  },
  {
    ...
    item: (
      <svg className={styles.github} width='21' height='20' xmlns='http://www.w3.org/2000/svg'>
        <path
          fillRule='evenodd'
          clipRule='evenodd'
  ...
  },
  {
    ...
    item: (
      <svg className={styles.youtube} width='20' height='16' xmlns='http://www.w3.org/2000/svg'>
