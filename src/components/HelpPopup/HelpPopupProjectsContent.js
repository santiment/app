    ...
    <div className='HelpPopupProjectsContent'>
      ...
      <ol className='HelpPopupProjectsContent__list'>
        <li className='HelpPopupProjectsContent__item'>
          ...
          <p>
            Look at the DAILY ACTIVE ADDRESSES column to see how many unique
            addresses participated in transactions for that token for the last
            30 days. Sudden increases in activity can sometimes preceed sharp
            price movements.
          </p>
        </li>
        <li className='HelpPopupProjectsContent__item'>
          ...
          <p>
            Look for this figure in the ETH SPENT column. Activity here could
            effect the price of ETH and, by extention, related tokens.
          </p>
        </li>
        <li className='HelpPopupProjectsContent__item'>
          <h4>
