    ...
    <section className={cx(styles.wrapper, className)}>
      <div className={styles.content}>
        ...
        <div className={styles.block}>
          ...
          <p className={styles.desc}>
            Want to give more context about crypto market events to your
            audience? We help content creators big and small elevate their
            market coverage with hard data and explore new, untapped market
            storylines.
          </p>
