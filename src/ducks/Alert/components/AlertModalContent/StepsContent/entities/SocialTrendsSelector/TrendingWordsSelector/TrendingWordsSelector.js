...
import TrendingWordsList from "./TrendingWordsList/TrendingWordsList";
import StepTitle from "../../../StepTitle/StepTitle";
import { useAssets } from "../../../../../../../../hooks/project";
import styles from "./TrendingWordsSelector.module.scss";
...
const AssetSelector = ({
  ...
  const [, { value }, { setValue: setWord }] = useField("settings.target.word");
