...
import { METRICS_DEPENDENCIES } from '../../../utils/utils'
  ...
  return (
    <div>
      <div className={styles.row}>
        {type &&
          METRICS_DEPENDENCIES[type.value].includes('absoluteBorderLeft') && (
        ...
        {type &&
          METRICS_DEPENDENCIES[type.value].includes('absoluteThreshold') && (
          <div className={styles.Field}>
