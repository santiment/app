...
export default ({ settings,  ...rest }) => {
    ...
    setOptions(state => {
      return {
        ...
        isMultiChartsActive: saveToggle(
          'isMultiChartsActive',
          typeof forceValue === "boolean" ? forceValue : !state.isMultiChartsActive
        )
      }
    })
  }
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <Settings {...rest} settings={settings} className={styles.settings} toggleMultiCharts={toggleMultiCharts} />
    </div>
  )
}
