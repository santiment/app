        ...
        <div className={styles.block}>
          <div className={styles.icon}>
            <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" clipRule="evenodd" d="M4 1C4 0.447715 4.44772 0 5 0C5.55228 0 6 0.447715 6 1V9C6 9.55228 5.55228 10 5 10C4.44772 10 4 9.55229 4 9V1ZM0 5C0 4.44772 0.447715 4 1 4C1.55228 4 2 4.44772 2 5V9C2 9.55228 1.55228 10 1 10C0.447715 10 0 9.55228 0 9V5ZM9 6C8.44771 6 8 6.44772 8 7V9C8 9.55229 8.44771 10 9 10C9.55229 10 10 9.55229 10 9V7C10 6.44772 9.55229 6 9 6Z" fill="#7A859E"/>
            </svg>
          </div>
          <div className={styles.info}>
