...
const LoadableEthMinersDashboard = LoadablePage(() =>
  import('./pages/EthMinersStats/EthMinersStats')
)
    ...
    <ErrorBoundary>
      ...
      <ErrorBoundary>
        <Switch>
          ...
          />
          <Route
            path={PATHS.ETH_MINERS_STATS}
            render={props => (
              <LoadableEthMinersDashboard isDesktop={isDesktop} {...props} />
            )}
          />
          <Route
