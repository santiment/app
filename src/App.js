  ...
  return (
    <div
      className={cx(
        ...
        (isWatchlistPageInDesktopMode && isLessThan20) ? styles['list-full-height'] : styles['list-height']
      )}
    >
        ...
        <ErrorBoundary history={history}>
          ...
          <Switch>
            ...
            <Route
              exact
              path='/labs/trends'
              component={LoadableTrendsLabsPage}
            />
