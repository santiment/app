...
export const APP_USER_NIGHT_MODE_SAVE_FAILED = '[app] USER_NIGHT_MODE_SAVE_FAILED';
export const APP_USER_BETA_MODE_SAVE = '[app] USER_BETA_MODE_SAVE';
export const APP_USER_BETA_MODE_SAVE_FAILED = '[app] USER_BETA_MODE_SAVE_FAILED'; // user
...
export const USER_TOGGLE_BETA_MODE = '[user] TOGGLE_BETA_MODE'; // user / settings

export const SETTINGS_REMOVE_CONNECTED_WALLET = '[user] REMOVE_CONNECTED_WALLET';
export const SETTINGS_REMOVE_CONNECTED_WALLET_SUCCESS = '[user] REMOVE_CONNECTED_WALLET_SUCCESS';
export const SETTINGS_REMOVE_CONNECTED_WALLET_FAILED = '[user] REMOVE_CONNECTED_WALLET_FAILED';
export const SETTINGS_CONNECT_NEW_WALLET = '[user] CONNECT NEW WALLET';
export const SETTINGS_CONNECT_NEW_WALLET_SUCCESS = '[user] CONNECT NEW WALLET SUCCESS';
export const SETTINGS_CONNECT_NEW_WALLET_FAILED = '[user] CONNECT NEW WALLET FAILED';
export const SETTINGS_GENERATE_TELEGRAM_DEEP_LINK = '[user] GENERATE_TELEGRAM_DEEP_LINK';
export const SETTINGS_REVOKE_TELEGRAM_DEEP_LINK = '[user] REVOKE_TELEGRAM_DEEP_LINK';
export const SETTINGS_REVOKE_TELEGRAM_DEEP_LINK_SUCCESS = '[user] SETTINGS_REVOKE_TELEGRAM_DEEP_LINK_SUCCESS';
export const SETTINGS_GENERATE_TELEGRAM_DEEP_LINK_SUCCESS = '[user] GENERATE_TELEGRAM_DEEP_LINK_SUCCESS';
export const SETTINGS_GENERATE_TELEGRAM_DEEP_LINK_FAILED = '[user] GENERATE_TELEGRAM_DEEP_LINK_FAILED';
export const SETTINGS_CONNECT_TELEGRAM = '[user] CONNECT_TELEGRAM';
export const SETTINGS_CONNECT_TELEGRAM_SUCCESS = '[user] CONNECT_TELEGRAM_SUCCESS';
export const SETTINGS_CONNECT_TELEGRAM_CANCEL = '[user] CONNECT_TELEGRAM_CANCEL'; // assets

export const USER_ADD_ASSET_TO_LIST = '[user] ADD_ASSET_TO_LIST';
export const USER_ADD_ASSET_TO_LIST_SUCCESS = '[user] USER_ADD_ASSET_TO_LIST_SUCCESS';
export const USER_ADD_ASSET_TO_LIST_FAILED = '[user] USER_ADD_ASSET_TO_LIST_FAILED';
export const USER_REMOVE_ASSET_FROM_LIST = '[user] REMOVE_ASSET_FROM_LIST';
export const USER_REMOVED_ASSET_FROM_LIST_SUCCESS = '[user] REMOVED_ASSET_FROM_LIST';
export const USER_REMOVED_ASSET_FROM_LIST_FAILED = '[user] REMOVED_ASSET_FROM_LIST';
export const USER_EDIT_ASSETS_IN_LIST = '[assets] EDIT_ASSETS_IN_LIST';
export const USER_EDIT_ASSETS_IN_LIST_SUCCESS = '[assets] EDIT_ASSETS_IN_LIST_SUCCESS';
export const USER_EDIT_ASSETS_IN_LIST_FAILED = '[assets] EDIT_ASSETS_IN_LIST_FAILED';
