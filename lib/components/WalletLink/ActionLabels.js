...
}) => link.length > 7 && link.length > linkSymbolsCount ? link.slice(0, isExchange ? 7 : linkSymbolsCount) + '...' : link;
export const EtherscanLink = ({
  ...
  const addressShort = isFull || typeof link !== 'string' ? link : makeShortAddresLink({
    link,
    isExchange,
    settings
  });
...
const ActionLabels = _ref => {
  ...
  }, content, /*#__PURE__*/React.createElement(EtherscanLink, _extends({}, rest, {
    isExchange: isExchange
  })), labels && /*#__PURE__*/React.createElement(TransactionTableLabels, {
    labels: labels
  }));
};
