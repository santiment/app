...
import styles from './CustomImageSideButton.module.css';
...
class CustomImageSideButton extends ImageSideButton {
  onChange(e) {
    ...
    if (file.type.indexOf('image/') === 0) {
      ...
      mutate({
        ...
        setEditorState(addNewBlock(getEditorState(), Block.IMAGE, {
          src: uploadImageUrl
        }));
      }).catch(error => {
        store.dispatch(showNotification('Upload image error'));
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", {
      className: "md-sd-button"
    }, /*#__PURE__*/React.createElement("label", {
      className: styles.label,
      htmlFor: "md-sd-img-button"
