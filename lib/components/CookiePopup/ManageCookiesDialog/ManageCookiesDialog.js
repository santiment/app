...
import styles from './ManageCookiesDialog.module.css';

const ManageCookiesDialog = ({
  cookiesPolicies,
  basePolicy
}) => {
  ...
  }, "When you visit our website, we may store cookies on your browser for your security and to help us better understand user behavior and inform us about which parts of our website you have visited. The information does not usually directly identify you, but it can give you a safe and more personalized web experience. Because we respect your right to privacy, you can choose not to allow some types of cookies. Blocking some types of cookies may impact your experience on the site.", ' ', /*#__PURE__*/React.createElement("a", {
    href: "https://santiment.net/cookies/",
    target: "_blank",
    rel: "noopener noreferrer",
    className: styles.link
  }, "Learn more")), cookiesPolicies.map(item => /*#__PURE__*/React.createElement(CookieCheckbox, _extends({
  ...
  }, "Save cookie settings"), /*#__PURE__*/React.createElement(Button, {
    variant: "flat",
    border: true,
