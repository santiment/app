...
export default (({
  ...
  className: cx(styles.features, classes.features)
}, data.map((feature, i) => /*#__PURE__*/React.createElement("li", {
  key: i,
  className: cx(styles.feature, classes.feature)
}, /*#__PURE__*/React.createElement(MarkIcon, {
  className: cx(styles.feature__icon, isGreen && styles.feature__icon__green, classes.feature__icon)
