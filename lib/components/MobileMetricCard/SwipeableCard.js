...
const SwipeableCard = ({
  ...
  const onCardClick = () => {
    if (side === SIDES.LEFT || currentGesture || isSwipe || startPos || offset) {} else {
      setSide(SIDES.RIGHT);
      setTimeout(() => {
        onRightAction();
      }, 60);
  ...
  const haveAction = side => side === SIDES.RIGHT && hasRightAction || side === SIDES.LEFT && hasLeftAction;
  ...
  const onMove = evt => {
    ...
    if (isSwipe === null) {
      if (isSwipeEvent({
        ...
        setIsSwipe(true); // NOTE: For Safari, will ignore in Chrome (due to passive event)
    ...
    setCurrentGesture(_objectSpread(_objectSpread({}, currentGesture), {}, {
      prevX: x
    }));
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: cx(styles.wrapper, styles[`wrapper__${side}`], offset && styles.wrapper__action, offset === FULL_HIDE_POSITION && styles.wrapper__hide, isSelected && styles.wrapper__selected, withAnimation && styles.wrapper__animation),
    style: {
      '--button-width': `${BUTTON_WIDTH}px`
    }
  }, hasLeftAction && /*#__PURE__*/React.createElement("button", {
    className: cx(styles.button, styles.button__left),
    onClick: onLeftAction
  }, /*#__PURE__*/React.createElement(Icon, {
    type: "info-round"
  })), hasRightAction && /*#__PURE__*/React.createElement("button", {
    className: cx(styles.button, styles.button__right),
    onClick: onRightAction
  }, /*#__PURE__*/React.createElement(Icon, {
    type: isSelected ? 'remove' : 'plus-round'
