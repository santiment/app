...
const createCacheUpdate = subsId => function updateCache(cache, {
  data: {
    cancelSubscription
  }
}) {
  ...
  const canceled = currentUser.subscriptions.find(({
    id
  }) => id === subsId);
...
const CancelPlanDialog = ({
  ...
  return /*#__PURE__*/React.createElement(Mutation, {
    ...
    onClose: closeDialog,
    trigger: noTrigger ? null : /*#__PURE__*/React.createElement(Button, {
      onClick: openDialog,
      accent: "positive"
    }, "Cancel subscription")
