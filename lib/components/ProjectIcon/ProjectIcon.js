...
export const ProjectIcon = ({
  ...
  return logo ? /*#__PURE__*/React.createElement("img", {
    src: logo,
    width: size,
    height: size,
    ...
    type: size > 20 ? 'assets' : 'asset-small'
  }));
};
...
export default compose(graphql(PROJECT_ICON_QUERY, {
  skip: ({
    logoUrl,
    slug
  }) => !!logoUrl || !!PREDEFINED_ICONS[slug] || !slug
}))(ProjectIcon);