const _excluded = ["insights", "trendWords", "projects", "isEditingWatchlist", "isCopyingAssets", "checkedAssets", "watchlistItems", "onSuggestionSelect"];
...
const assetsPredicate = searchTerm => {
  ...
  return ({
    ...
    name,
    slug
  }) => name.toUpperCase().includes(upperCaseSearchTerm) || ticker.toUpperCase().includes(upperCaseSearchTerm) || slug.toUpperCase().includes(upperCaseSearchTerm);
};
...
}, isCopyingAssets ? /*#__PURE__*/React.createElement(Checkbox, {
...
}, ticker)), isEditingWatchlist && /*#__PURE__*/React.createElement(Icon, {
...
const Header = () => {
  return /*#__PURE__*/React.createElement("div", {
    className: cx(styles.header, 'c-waterloo row justify v-center')
  }, /*#__PURE__*/React.createElement("div", null, "Press enter to add one of few assets"), /*#__PURE__*/React.createElement("svg", {
    width: "24",
    height: "20",
    viewBox: "0 0 24 20",
    fill: "none",
    ...
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M17 5.5994C17 5.26836 16.717 5 16.3679 5C16.0187 5 15.7357 5.26836 15.7357 5.5994V9.22339C15.7357 9.61364 15.5722 9.9879 15.2812 10.2639C14.9902 10.5398 14.5955 10.6948 14.1839 10.6948H9.15835L11.355 8.6119C11.6019 8.37782 11.6019 7.9983 11.355 7.76421C11.1082 7.53013 10.7079 7.53013 10.4611 7.76421L7.18515 10.8705C6.93828 11.1046 6.93828 11.4841 7.18515 11.7182L10.4611 14.8244C10.7079 15.0585 11.1082 15.0585 11.355 14.8244C11.6019 14.5904 11.6019 14.2108 11.355 13.9768L9.15815 11.8936H14.1839C14.9308 11.8936 15.6471 11.6123 16.1752 11.1115C16.7033 10.6108 17 9.93158 17 9.22339V5.5994Z",
    fill: "white"
  })));
};

const SearchProjects = _ref => {
  let {
    insights = [],
    trendWords = [],
    projects = [],
  ...
  return /*#__PURE__*/React.createElement(SearchWithSuggestions, _extends({}, props, {
    ...
    data: [{
      ...
      suggestionContent: ({
        ...
        const isAssetInList = isEditingWatchlist ? hasAssetById({
          listItems: watchlistItems,
          id
        }) : false;
        return /*#__PURE__*/React.createElement(AssetSuggestion, {
...
const enhance = compose(graphql(TRENDING_WORDS_QUERY, {
  skip: ({
    noTrends
  }) => noTrends,
  options: () => {
  ...
  props: ({
    ...
    return {
      trendWords: trendWords ? trendWords.topWords.map(({
        word
      }) => word) : []
    };
  }
