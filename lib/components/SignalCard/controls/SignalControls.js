...
import { DAILY_ACTIVE_ADDRESSES, ETH_WALLET, METRIC_TYPES, PRICE_ABSOLUTE_CHANGE, PRICE_PERCENT_CHANGE, PRICE_VOLUME_DIFFERENCE, SIGNAL_METRIC_TYPES } from '../../../ducks/Signals/utils/constants';
...
const getIconStyles = (type, metric) => {
  switch (type) {
    ...
    case METRIC_TYPES.METRIC_SIGNAL:
      {
        if (metric === SIGNAL_METRIC_TYPES.daily_active_addresses || metric === SIGNAL_METRIC_TYPES.active_addresses_24h) {
...
export const SignalTypeIcon = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: cx(iconClass, isFrozen && styles.frozenIcon, className)
