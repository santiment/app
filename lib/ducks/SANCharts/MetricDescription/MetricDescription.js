...
const getPrepared = (description, project = {
  ticker: 'project'
}) => {
  if (!description) {
    return description;
...
const MetricDescription = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, getPrepared(description, project), link && /*#__PURE__*/React.createElement(MoreInfoLink, {
    href: link
  }));
};
