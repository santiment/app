...
import { isTrendingWordsByProjects, isTrendingWordsByWatchlist, isTrendingWordsByWords, mapToAssets } from '../../../utils/utils';
...
const getWords = (allProjects, trendingWordsWithWords) => {
  ...
  const preselectedWords = Array.isArray(trendingWordsWithWords) ? trendingWordsWithWords : trendingWordsWithWords ? [trendingWordsWithWords] : [];
...
const TriggerFormTrendingWordsTypes = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    options: TRENDING_WORDS_TYPE_OPTIONS.map(({
      value
    }) => value),
    nameOptions: TRENDING_WORDS_TYPE_OPTIONS.map(({
      label
    }) => label),
    ...
    className: cx(styles.row, styles.rowBottom)
  }, /*#__PURE__*/React.createElement("div", {
    className: cx(styles.Field, styles.fieldFilled)
  }, isWatchlist && /*#__PURE__*/React.createElement(TriggerFormWatchlists, {
    values: values,
    setFieldValue: setFieldValue
  }), !isWatchlist && /*#__PURE__*/React.createElement(GetProjects, {
    render: ({
      isLoading,
      allProjects = []
    }) => {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, isProjects && /*#__PURE__*/React.createElement(TriggerProjectsSelector, {
        name: "target",
        target: target,
        projects: allProjects,
        setFieldValue: setFieldValue
      }), isWords && /*#__PURE__*/React.createElement(FormikSelect, {
        multi: true,
        isCreatable: true,
