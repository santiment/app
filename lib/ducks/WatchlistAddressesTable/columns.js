...
export const combineColumns = dynamicColumns => DEFAULT_COLUMNS.concat(prepareColumns(dynamicColumns));
...
const ASSETS_DISTRIBUTION_CELL = obj => obj.address && /*#__PURE__*/React.createElement(AssetsDistributionColumn, {
  address: obj.address,
...
export const CURRENT_BALANCE_CELL = key => obj => obj[key] && balanceValue.format(obj[key].balanceEnd);
export const BALANCE_CHANGE_PERCENT_CELL = key => obj => obj[key] && /*#__PURE__*/React.createElement(ValueChange, {
  change: obj[key].balanceChangePercent
});
export const BALANCE_CHANGE_CHART_CELL = (key, slug) => obj => obj[key] && /*#__PURE__*/React.createElement(MiniChart, {
  address: obj.address,
  slug: slug,
  change: obj[key].balanceChangePercent
});