...
import { getTextWidth } from '@santiment-network/chart/utils'; // import COLOR from '@santiment-network/ui/variables.scss'
...
const LastDayPrice = ({
  ...
  useEffect(() => {
    ...
    chart.plotter.register('lastDayPrice', lastDayPrice ? () => drawLastDayPrice(chart, lastDayPrice) : noop);
  }, [data, from, to]);
  return null;
};
