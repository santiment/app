...
const MetricFavorite = ({
  ...
  return /*#__PURE__*/React.createElement(ExplanationTooltip, {
    ...
    d: "M11.74 14.85c-.19 0-.38-.05-.54-.14l-3.12-1.64a.17.17 0 00-.16 0l-3.11 1.64a1.17 1.17 0 01-1.7-1.23L3.7 10a.17.17 0 00-.06-.15L1.14 7.4a1.17 1.17 0 01.65-2l3.48-.5a.17.17 0 00.12-.1l1.56-3.15a1.17 1.17 0 012.1 0l1.55 3.16a.17.17 0 00.13.09l3.49.5a1.17 1.17 0 01.65 2l-2.53 2.46a.17.17 0 00-.05.15l.6 3.47a1.17 1.17 0 01-1.15 1.36z"
  }))));
};
