...
const ChartPreview = ({
  ...
  const {
    firstWord,
    rest
  } = splitStr(conditionsStr);
  return /*#__PURE__*/React.createElement("div", {
    className: styles.wrapper
  }, !isWallet && /*#__PURE__*/React.createElement("div", {
    className: styles.info
  }, /*#__PURE__*/React.createElement("div", {
    className: styles.condition
  }, /*#__PURE__*/React.createElement("span", {
    className: styles.conditionType
  }, firstWord), rest), /*#__PURE__*/React.createElement("div", {
    className: styles.price
  }, !loading && shouldRenderPrice && `1 ${project && project.ticker} = ${formatNumber(data, {
    currency: 'USD'
  })}`)), /*#__PURE__*/React.createElement("div", {
    className: cx(styles.chartWrapper, !shouldRenderChart && styles.noChart)
  }, shouldRenderChart && /*#__PURE__*/React.createElement(SignalPreview, {
    type: values.type,
    trigger: values
  })));
};
