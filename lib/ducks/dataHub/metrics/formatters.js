...
const currencyFormatter = (val, currency) => val || val === 0 ? formatNumber(val, {
  currency
}) : 'No data';
...
export const absoluteToPercentsFormatter = val => percentageFormatter(100 * val); // NOTE: "- 1" operation were done in fetcher before [haritonasty | Feb 11, 2021]
