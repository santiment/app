...
export const checkIfAreMirrored = (metricA, metricB) => MirroredMetric[metricA.key] === metricB || MirroredMetric[metricB.key] === metricA;

const mirrorTransformer = metricKey => data => data.map(item => ({
