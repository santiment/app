...
import styles from './Frequence.module.css';
export const Link = ({
  href,
  children
}) => {
...
const FiveMinute = /*#__PURE__*/React.createElement(Link, {
  href: "https://academy.santiment.net/metrics/details/frequency#five-minute-frequency"
}, "Five-Minute Intervals");
const Daily = /*#__PURE__*/React.createElement(Link, {
  href: "https://academy.santiment.net/metrics/details/frequency#daily-frequency"
}, "Daily Intervals");
const Hourly = /*#__PURE__*/React.createElement(Link, {
  href: "https://academy.santiment.net/metrics/details/frequency#hourly-frequency"
}, "Hourly Intervals");
const Sentiment = /*#__PURE__*/React.createElement("div", {
  className: styles.text
}, "We store each of the", ' ', /*#__PURE__*/React.createElement(Link, {
  href: "https://academy.santiment.net/metrics/details/social-data"
}, "social data"), ' ', "documents with its absolute timestamp. I.e. it is possible to aggregate the data with any desired interval", ' ', /*#__PURE__*/React.createElement(Link, {
  href: "https://academy.santiment.net/products-and-plans/access-plans/"
}, "on request"), ". Currently the time intervals we use are the following: 6h, 12h, 1d."); // [GarageInc] Missed Community Messages Count, Top Holders, Top Social Gainers / Losers
