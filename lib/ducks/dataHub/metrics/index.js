...
import { usdFormatter, btcFormatter, ethFormatter, percentageFormatter, absoluteToPercentsFormatter, tooltipValueFormatter, mvrvFormatter } from './formatters';
import { updateTooltipSettings } from '../tooltipSettings';
import { Node } from '../../Chart/nodes';
import { millify } from '../../../utils/formatting';
import { HolderDistributionCombinedBalanceAbsoluteMetric, HolderDistributionMetric, HoldersLabeledDistributionMetric } from '../../Studio/Chart/Sidepanel/HolderDistribution/metrics';
import { HOLDER_DISTRIBUTION_COMBINED_BALANCE_NODE, HOLDER_DISTRIBUTION_NODE, HOLDER_LABELED_DISTRIBUTION_NODE } from '../../Studio/Sidebar/nodes';
export function deriveMetric(baseMetric, newMetric) {
  ...
  if (reqMeta) {
    newMetric.reqMeta = _extends({}, baseMetric.reqMeta, reqMeta);
  }

  return _extends({}, baseMetric, newMetric);
}
...
export const Metric = {
  ...
  social_volume_total: {
    ...
    formatter: value => tooltipValueFormatter({
      value
    })
  },
  social_active_users: {
  ...
  uniswap_lp_claims_count: {
    ...
    description: 'The number of uniq addresses that  provided liquidity and claimed  UNI per timeframe',
    color: '#ffad4d'
  },
  ...
  [HolderDistributionCombinedBalanceAbsoluteMetric.holders_distribution_combined_balance_1_to_10.key]: HOLDER_DISTRIBUTION_COMBINED_BALANCE_NODE,
  [HoldersLabeledDistributionMetric.holders_labeled_distribution_1_to_10.key]: HOLDER_LABELED_DISTRIBUTION_NODE,
  mcd_locked_token: {
    category: 'On-chain',
