...
const NEW_METRICS = [Metric.transaction_volume_usd, Metric.price_daa_divergence, Metric.adjusted_price_daa_divergence, Metric.active_addresses_24h, Metric.active_addresses_1h, Metric.network_profit_loss, Metric.dev_activity_contributors_count, Metric.average_fees_usd, Metric.median_fees_usd, Metric.mvrv_usd_intraday, Metric.whale_transaction_count_100k_usd_to_inf, Metric.whale_transaction_count_1m_usd_to_inf, Metric.mvrv_usd_z_score, Metric.holders_labeled_distribution_1_to_10];
export const NEW_METRIC_KEY_SET = new Set(NEW_METRICS.map(({
  key
}) => key));
