...
import inputStyles from '../../../../components/BlockchainLabelsSelector/BlockchainLabelsSelector.module.css';
const ROW_HEIGHT = 32;
...
const AssetsList = ({
  ...
  useEffect(() => {
    ...
    if (filter.length > 0) {
      ...
      filteredItems = type === BLOCKCHAIN_ADDRESS ? filteredItems.filter(({
        blockchainAddress
      }) => blockchainAddress.address.toLowerCase().includes(normalizedFilter)) : filteredItems.filter(({
        name,
        ticker
      }) => {
  ...
  const rowRenderer = ({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      isActive: isSelectedAsset,
      className: styles.checkbox
    }), /*#__PURE__*/React.createElement(Label, {
      className: styles.name
    }, type === BLOCKCHAIN_ADDRESS ? blockchainAddress.address : name), type !== BLOCKCHAIN_ADDRESS && /*#__PURE__*/React.createElement(Label, {
      accent: "casper"
    }, ticker));
  };
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, withSearch && /*#__PURE__*/React.createElement(InputWithIcon, {
    type: "text",
    icon: "search-small",
    iconPosition: "left",
