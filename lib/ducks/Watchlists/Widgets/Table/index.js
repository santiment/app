...
const hasColumn = (columns, key) => columns.find(({
  accessor
}) => accessor === key);
...
const AssetsTable = ({
  ...
  useEffect(() => {
    window.dispatchEvent(new CustomEvent('comparingAssetsChanged', {
      detail: comparingAssets
    }));
  }, [comparingAssets]);
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TableTop, {
    widgets: widgets,
