...
import { useLocation } from 'react-router-dom'; // import toReact from 'svelte-adapter/react'

import Icon from '@santiment-network/ui/Icon';
import CreationInfoComponent from './CreationInfoWrapper.svelte';
import CommentsComponent from 'san-webkit/lib/ui/Comments/svelte';
import { CreationType } from 'san-webkit/lib/ui/Profile/types';
import { CommentsType } from 'san-webkit/lib/api/comments';
import { lookupSavedComment, clearSavedComment } from 'san-webkit/lib/ui/Comments/utils';
