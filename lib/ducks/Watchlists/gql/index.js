...
`;
export const getRecentWatchlist = id => client.query({
...
export function tableQuery(columns) {
  ...
  query allProjectsByFunction($fn: json) {
    ...
    aggregation
            ...
            metric: "${accessor}"
            from: "utc_now-${aggregation.toUpperCase() === AGGREGATIONS_UPPER.LAST ? accessor === 'sentiment_volume_consumed_total_change_1d' ? '2d' : '1d' : timeRange}"
            to: "utc_now"
