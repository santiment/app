...
import { FEATURED_WATCHLISTS_QUERY, USER_SHORT_WATCHLISTS_QUERY, USER_WATCHLISTS_QUERY } from './queries';
...
export const getWatchlistsShortQuery = type => USER_SHORT_WATCHLISTS_QUERY(transformToServerType(type));
export const getWatchlistsQuery = type => USER_WATCHLISTS_QUERY(transformToServerType(type));
export const getFeaturedWatchlistsQuery = type => FEATURED_WATCHLISTS_QUERY(transformToServerType(type));