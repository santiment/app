...
`;
export const getStats = type => type !== BLOCKCHAIN_ADDRESS ? '' : `
  stats {
    blockchainAddressesCount
  }`;
export const getListItemsShortFragment = type => type === BLOCKCHAIN_ADDRESS ? ADDRESSES_SHORT_LIST_ITEMS_FRAGMENT : PROJECTS_SHORT_LIST_ITEMS_FRAGMENT;
export const getListItemsFragment = type => type === BLOCKCHAIN_ADDRESS ? ADDRESSES_SHORT_LIST_ITEMS_FRAGMENT : PROJECTS_LIST_ITEMS_FRAGMENT;