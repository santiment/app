...
const getLastUpdated = () => localStorage.getItem(LAST_UPDATES_KEY) ? new Date(localStorage.getItem(LAST_UPDATES_KEY)) : undefined;
...
const NotificationsFeed = () => {
  ...
  function loadMore() {
    if (!loading && canLoad && !error) {
      ...
      const targetDate = last && settings.date !== last.insertedAt ? new Date(new Date(last.insertedAt).getTime() - 1000) : NOW;
  ...
  const hasNew = useMemo(() => {
    return !lastLoadedDate && events.length !== 0 || events.some(item => isNew(item, lastLoadedDate));
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    trigger: /*#__PURE__*/React.createElement("div", {
      className: cx(styles.trigger, 'relative')
    }, hasNew && /*#__PURE__*/React.createElement("div", {
      className: cx(styles.counter, 'caption txt-center txt-m')
    }, newCount), /*#__PURE__*/React.createElement(Icon, {
      type: "bell",
      className: cx(styles.icon, 'btn-ghost')
    }))
  ...
  }, /*#__PURE__*/React.createElement(NotificationTypes, {
    ...
    threshold: 200,
    useWindow: false
  }, events.map((item, index) => /*#__PURE__*/React.createElement(NotificationItem, {
    data: item,
    key: item.id,
    isOpened: isOpened,
  ...
  }))), !loading && events.length === 0 && /*#__PURE__*/React.createElement(Warning, {
    settings: settings
  }))))));
};
...
const Warning = ({
  ...
  return settings.type === 'ALL' ? /*#__PURE__*/React.createElement(NoNotitications, {
    description: "Your new messages will appear here",
    showSvg: true
  }) : /*#__PURE__*/React.createElement(NoNotitications, {
    description: "There\u2019s no activity for this tag, please select another one"
  });
};
