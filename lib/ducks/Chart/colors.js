...
const ALPHA_CHANNEL = '29'; // RESERVED COLORS
...
const ORANGE = '#FFAD4D';
const GRAY = '#D2D6E7';
export const COLORS = ['#F47BF7', // PURPLE
RED, // RED
'#FFCB47', // YELLOW
'#5275FF', // BLUE
'#FF8450', // SALMON
...
export function useHighlightMetricColor(MetricColor, focusedMetricKey) {
  return useMemo(() => highlightMetricColor(MetricColor, focusedMetricKey), [MetricColor, focusedMetricKey]);
}
