...
export function findMetricValueByY(chart, {
  key
}, y) {
  const {
    minMaxes,
...
export function findMetricLastValue(data, {
  key
}) {
...
export const checkPriceMetric = metric => metric === Metric.price_usd || metric.base === Metric.price_usd;
