...
export default buildPlotter((chart, {
  ...
  useEffect(() => {
    ...
    plotter.register('candles', (chart, scale, data, colors, categories) => plotCandles(chart, data, categories.candles, scale, colors)); // TODO: Make tooltip settings chart local [@vanguard | Mar 18, 2021]
