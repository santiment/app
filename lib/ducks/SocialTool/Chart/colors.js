...
export const SOCIAL_VOLUME_COLORS = ['#68DBF4', // CYAN
'#FF5B5B', // RED
'#5275FF', // BLUE
'#AC948C', // BROWN-GRAY
'#D4E763' // YELLOW-GREEN
];
export const SOCIAL_DOMINANCE_COLORS = ['#FFCB47', // YELLOW
'#F47BF7', // PURPLE
'#FF8450', // SALMON
'#FFDAC5', // PEACH
'#37D7BA' // AQUAMARINE
...
export function useChartColors(metrics, focusedMetric) {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < length; i++) {
      ...
      let color = MetricColor[key] || COLORS[queryKey][freeColorIndex[queryKey]++];
