...
export const DEFAULT_METRICS = [Metric.social_volume_total, Metric.price_usd, getSavedToggle('isSocialDominanceActive') && Metric.social_dominance_total].filter(Boolean);