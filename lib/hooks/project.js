...
import { ALL_PROJECTS_FOR_SEARCH_QUERY, ALL_PROJECTS_SOCIAL_VOLUME_CHANGES_QUERY, buildInfographicQuery, PROJECT_BY_ID_QUERY, PROJECT_WITH_SLUG_QUERY } from '../ducks/Watchlists/gql/allProjectsGQL';
...
export function useProject(slug) {
  const {
    ...
    loading,
    error
  } = useQuery(PROJECT_WITH_SLUG_QUERY, {
...
export function useProjectPriceChanges({
  ...
  const gqlQuery = buildInfographicQuery({
    metric,
    interval
  });
