...
export const isListPath = path => path.includes(PATHS.PROJECTS_WATCHLIST) || path.includes(PATHS.ADDRESSES_WATCHLIST) || path.includes(PATHS.SCREENER) || path.includes('/assets/list');