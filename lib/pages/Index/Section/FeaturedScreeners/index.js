...
const FeaturedScreeners = () => {
  ...
  const tabs = useMemo(() => featuredScreeners.map(({
    name
  }) => name).slice(0, 4), [featuredScreeners]);
  useEffect(() => {
  ...
  }, tab && /*#__PURE__*/React.createElement(Tabs, {
  ...
  }, "Start researching ", tab), /*#__PURE__*/React.createElement(Container, null, activeScreener && /*#__PURE__*/React.createElement(Table, {
