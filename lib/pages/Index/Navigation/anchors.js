...
export const NFTINFLUENCERS_ANCHOR = 'nft-influencers';
export const SCROLLABLE_ANCHORS = [SHEETS_ANCHOR, KEYSTACKHOLDERS_ANCHOR, VIDEOS_ANCHOR, CABINET_ANCHOR, SOCIAL_ANCHOR, CHARTS_ANCHOR, SCREENERS_ANCHOR, NFTINFLUENCERS_ANCHOR];
export const TOP_LINKS = [{
  title: 'NFT Influencers Trx',
  link: NFTINFLUENCERS_ANCHOR,
  Icon: () => /*#__PURE__*/React.createElement("svg", {
    ...
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M16 9L22.5 12.5263V19.4737L16 23.0001L9.5 19.4737L9.5 12.5263L16 9ZM15.5231 8.12102C15.8206 7.95966 16.1794 7.95966 16.4769 8.12102L22.9769 11.6474C23.2992 11.8223 23.5 12.1596 23.5 12.5263V19.4737C23.5 19.8405 23.2992 20.1778 22.9769 20.3527L16.4769 23.8791C16.1794 24.0404 15.8206 24.0404 15.5231 23.8791L9.02314 20.3527C8.70077 20.1778 8.5 19.8405 8.5 19.4737V12.5263C8.5 12.1596 8.70077 11.8223 9.02314 11.6474L15.5231 8.12102ZM16.2248 10.9188C16.0694 10.8345 15.8809 10.8386 15.7292 10.9295L12.7333 12.7266C12.4965 12.8686 12.4197 13.1757 12.5618 13.4125C12.7038 13.6493 13.0109 13.7262 13.2477 13.5841L15.9989 11.9339L19.9483 14.0765L19.9483 18.4844C19.9483 18.7605 20.1721 18.9844 20.4483 18.9844C20.7244 18.9844 20.9483 18.7605 20.9483 18.4844L20.9483 13.779C20.9483 13.5956 20.8479 13.4269 20.6867 13.3395L16.2248 10.9188Z"
  })))
}, {
