...
const Watchlist = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Column, null, /*#__PURE__*/React.createElement(VisibilityIndicator, {
    isPublic: isPublic,
    className: styles.icon
  }), name), /*#__PURE__*/React.createElement("div", {
    className: styles.marketcap
  }, "$", millify(marketcapLast), /*#__PURE__*/React.createElement(PercentChanges, {
