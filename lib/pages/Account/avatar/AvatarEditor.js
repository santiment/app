...
const AvatarEditor = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ImageEditor, {
    imageUrl: avatarUrl,
    setOpen: setOpen,
    isOpen: isOpen,
  ...
  }, avatarUrl ? 'Change photo' : 'Add photo')), withRemove && avatarUrl && /*#__PURE__*/React.createElement("div", {
...
const mapDispatchToProps = dispatch => ({
  dispatchAvatarChanged: avatarUrl => dispatch({
    type: actions.USER_AVATAR_CHANGE,
    avatarUrl
  })
});

const enhance = compose(connect(null, mapDispatchToProps), graphql(CHANGE_AVATAR_MUTATION, {
  name: 'mutateChangeAvatar'
}), graphql(UPLOAD_IMG_QUERY, {
  name: 'mutateUploadImage'
}));
