...
export const dateDifferenceInWordsString = dateString => dateDifferenceInWords({
...
export function checkIsToday(targetDate) {
  ...
  return targetDate.getDate() === today.getDate() && targetDate.getMonth() === today.getMonth() && targetDate.getFullYear() === today.getFullYear();
}
