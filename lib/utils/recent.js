...
const addRecent = (type, item, count) => saveRecent(type, [item, ...removeRecent(type, item)].filter(Boolean), count); // slugs array


export const getRecentAssets = () => getRecent(RECENT_ASSETS); // IDs array

export const getRecentWatchlists = () => getRecent(RECENT_WATCHLISTS); // IDs array

export const getRecentScreeners = () => getRecent(RECENT_SCREENERS); // words array

export const getRecentTrends = () => getRecent(RECENT_TRENDS); // IDs array

export const getRecentTemplates = () => getRecent(RECENT_TEMPLATES); // metric keys array
...
export const removeRecentWatchlists = id => saveRecent(RECENT_WATCHLISTS, removeRecent(RECENT_WATCHLISTS, id));
export const removeRecentScreeners = id => saveRecent(RECENT_SCREENERS, removeRecent(RECENT_SCREENERS, id));
export const removeRecentTrends = word => saveRecent(RECENT_TRENDS, removeRecent(RECENT_TRENDS, word));
export const removeRecentAssets = asset => saveRecent(RECENT_ASSETS, removeRecent(RECENT_ASSETS, asset));
export const removeRecentTemplate = id => saveRecent(RECENT_TEMPLATES, removeRecent(RECENT_TEMPLATES, id.toString()));
export const removeRecentMetric = key => saveRecent(RECENT_MOBILE_METRICS, removeRecent(RECENT_MOBILE_METRICS, key), 6);
