...
export function register(config) {
  if ((process.env.NODE_ENV === 'production' || isLocalhost) && 'serviceWorker' in navigator && canExecuteSw()) {
...
export const requestNotificationPermission = (success, reject) => {
  const permission = window.Notification.requestPermission(); // value of permission can be 'granted', 'default', 'denied'
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            ...
            if (navigator.serviceWorker.controller) {
              ...
              registration.needUpdates = true; // Execute callback
