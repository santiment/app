...
import InsightsScrollable, {TYPES} from "../src/components/Insight/InsightsScrollable";
  ...
  .add('Scrollable', () => (
    <>
      ...
      <div style={{width: '300px', height: '350px', display: 'flex'}}>
        <InsightsScrollable type={TYPES.featured} maxLines={2} multilineTextId="testScrollable" />
      </div>
    </>
  ))
  .add('WithTitle', () => (
